...
### Structure
* Organisations have very different and complex internal organisational structures
* We assume a flexible hierarchichal structure will be enough to handle this

### RequirementProfiles
* An Organisation wants to share RequirementProfiles across mutliple OrgUnits
* We don't expect and Organisation to have very many different RequirementProfiles
...
* Filling out the same data for a RequirementProfile for a different Organisation is ok

### Permissions
* Roles are defined within an Organisation
