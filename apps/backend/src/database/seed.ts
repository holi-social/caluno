...
> = {
  ...
  [PERMISSIONS.ORG_ROLE_CREATE]: 'Create organization   role',
  [PERMISSIONS.ORG_ROLE_READ]: 'Read organization role',
  [PERMISSIONS.ORG_ROLE_UPDATE]: 'Update organization role',
  [PERMISSIONS.ORG_ROLE_DELETE]: 'Delete organization role',
  [PERMISSIONS.ORG_UNIT_ROLE_CREATE]: 'Create organization unit role',
  [PERMISSIONS.ORG_UNIT_ROLE_READ]: 'Read organization unit role',
  [PERMISSIONS.ORG_UNIT_ROLE_UPDATE]: 'Update organization unit role',
  [PERMISSIONS.ORG_UNIT_ROLE_DELETE]: 'Delete organization unit role',
