...
ALTER TABLE "form_submissions" ALTER COLUMN "status" SET DEFAULT 'SUBMITTED'::"form_submission_status";--> statement-breakpoint
ALTER TABLE "requirement_forms" DROP COLUMN "locale";