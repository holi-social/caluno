...
import type { DiscoverEvent } from '@repo/data/react';
...
export interface EventCardDiscoveryProps {
  event: DiscoverEvent;
}

export function EventCardDiscovery({ event }: EventCardDiscoveryProps) {
