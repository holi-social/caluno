...
/**
 * Use the `icon-xs` size for a smaller icon-only button.
 */
...
/**
 * Use the `icon-md` size for a larger icon-only button.
 */
...
/**
 * Pass `tooltip` for a hover label (wraps the button in ActionTooltip).
 */
