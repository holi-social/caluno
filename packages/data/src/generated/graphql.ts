...
export type MyEventFieldsFragment = { __typename?: 'Event', id: string, title: string, startsAt: string, endsAt: string, location?: string | null, myInvitedAt?: string | null, organizationUnit?: { __typename?: 'EventOrganizationUnit', id: string, name: string, logoUrl?: string | null } | null };
...
export type GetOrganizationQuery = { __typename?: 'Query', organization?: { __typename?: 'Organization', id: string, name: string, slug: string, description?: string | null, logoUrl?: string | null, websiteUrl?: string | null, contactEmail?: string | null, phone?: string | null, address?: string | null, createdAt: string, updatedAt?: string | null } | null };
...
export type GetMyOrganizationUnitsQuery = { __typename?: 'Query', myOrganizationUnits: Array<{ __typename?: 'OrganizationUnit', id: string, slug: string, name: string, description?: string | null, logoUrl?: string | null, address?: string | null, parent?: { __typename?: 'OrganizationUnit', id: string } | null, organization: { __typename?: 'Organization', id: string, name: string, description?: string | null, logoUrl?: string | null } }> };
...
export type UpdateOrganizationUnitMutation = { __typename?: 'Mutation', updateOrganizationUnit: { __typename?: 'OrganizationUnit', id: string, name: string, slug: string, deletedAt?: string | null, parent?: { __typename?: 'OrganizationUnit', id: string } | null, type: { __typename?: 'OrganizationUnitType', id: string, name: string, icon: string } } };
...
export type SubmitFormMutation = { __typename?: 'Mutation', submitForm: { __typename?: 'FormSubmission', id: string, formId: string, userId: string, status: FormSubmissionStatus, submittedAt: string } };
...
export type SubmitRequiredFormMutation = { __typename?: 'Mutation', submitRequiredForm: { __typename?: 'FormSubmission', id: string, formId: string, userId: string, status: FormSubmissionStatus, submittedAt: string } };
...
export type GetMyFormSubmissionByTokenQuery = { __typename?: 'Query', myFormSubmissionByToken?: { __typename?: 'FormSubmission', id: string, formId: string, userId: string, status: FormSubmissionStatus, submittedAt: string } | null };
...
export type GetMyFormSubmissionsQuery = { __typename?: 'Query', myFormSubmissions: Array<{ __typename?: 'FormSubmission', id: string, status: FormSubmissionStatus, submittedAt: string, form?: { __typename?: 'RequirementForm', id: string, name: string, description?: string | null, shareToken: string } | null }> };
...
export type GetFormSubmissionsByMembershipRequestQuery = { __typename?: 'Query', formSubmissionsByMembershipRequest: Array<{ __typename?: 'FormSubmission', id: string, status: FormSubmissionStatus, submittedAt: string, form?: { __typename?: 'RequirementForm', id: string, name: string } | null }> };
...
export type GetFormSubmissionsForVolunteerQuery = { __typename?: 'Query', formSubmissionsForVolunteer: Array<{ __typename?: 'FormSubmission', id: string, status: FormSubmissionStatus, submittedAt: string, form?: { __typename?: 'RequirementForm', id: string, name: string } | null }> };
...
export type GetFormSubmissionsByFormQuery = { __typename?: 'Query', formSubmissionsByForm: { __typename?: 'FormSubmissionPaginatedResponse', items: Array<{ __typename?: 'FormSubmission', id: string, status: FormSubmissionStatus, submittedAt: string, user?: { __typename?: 'User', id: string, name: string, email: string, checkInId: string, image?: string | null } | null }>, pagination: { __typename?: 'PaginationInfo', total: number, limit: number, offset: number, hasMore: boolean } } };
...
export type MyFormSubmissionQuery = { __typename?: 'Query', myFormSubmission?: { __typename?: 'FormSubmission', id: string, status: FormSubmissionStatus, submittedAt: string, form?: { __typename?: 'RequirementForm', id: string, name: string, blockRefs?: Array<{ __typename?: 'RequirementFormBlockRef', fieldOrder: number, block?: { __typename?: 'FormBlock', id: string, fields?: Array<{ __typename?: 'FormBlockField', id: string, label: string, type: FieldType, systemKey?: string | null, options?: Array<{ __typename?: 'SelectOption', label: string, value: string }> | null }> | null } | null }> | null } | null, values?: Array<{ __typename?: 'FormSubmissionValue', fieldId: string, value: string }> | null } | null };
...
export const SubmitFormDocument = gql`
    mutation SubmitForm($token: String!, $input: SubmitFormInput!) {
  submitForm(token: $token, input: $input) {
    id
    formId
    userId
    status
